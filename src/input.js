Final.input = (function() {
    ...
    function initialize() {
        if (localStorage.getItem('rightControl') === null) {
            localStorage.setItem('rightControl', 'ArrowRight');
        }
        if (localStorage.getItem('leftControl') === null) {
            localStorage.setItem('leftControl', 'ArrowLeft');
        }
        if (localStorage.getItem('fireControl') === null) {
            localStorage.setItem('fireControl', ' ');
        }
        
        Final.leftControl = localStorage.getItem('leftControl');
        Final.rightControl = localStorage.getItem('rightControl');
		Final.fireControl = localStorage.getItem('fireControl');
    }
